class DirectionInput {
  constructor() {
    ...
    // Add a reference to the slideshow's next and previous buttons
    this.nextButton = document.querySelector('.slideshow-container .next');
    this.prevButton = document.querySelector('.slideshow-container .prev');
  ...
  init() {
    ...
    const closePhotoButton = document.querySelector('#slideshow-container .close-button');
